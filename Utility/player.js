  ...
  class boneeplayer extends Player {
    ...
    setNightcore(nighcore) {
      if (typeof nighcore !== "boolean") {
        throw new RangeError('Player#setNighcore() Nightcore can only be "on" or "off".');
      }
    ...
    setVaporwave(vaporwave) {
      if (typeof vaporwave !== "boolean") {
        throw new RangeError('Player#setVaporwave() Vaporwave can only be "on" or "off".');
      }
    ...
    setDistortion(distortion) {
      if (typeof distortion !== "boolean") {
        throw new RangeError('Player#setDistortion() Distortion can only be "on" or "off"');
      }
    ...
    setBassboost(bassboost) {
      if (typeof bassboost !== "boolean") {
        throw new RangeError('Player#setBassboost() Bassboost can only be "on" or "off".');
      }
